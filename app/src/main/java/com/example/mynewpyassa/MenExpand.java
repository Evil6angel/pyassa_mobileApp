...
public class MenExpand extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_men_expand);
        ...
        CollectionReference menCateg = db.collection("menCateg");

        // Query the collection to get all documents
        menCateg.get().addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
            @Override
            ...
            public void onFailure(@NonNull Exception e) {
                ...
                Toast.makeText(MenExpand.this, "Error loading products", Toast.LENGTH_SHORT).show();
            }
        });
    }
